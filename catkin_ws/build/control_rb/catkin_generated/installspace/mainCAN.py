...
class ControllerProcess:
    def __init__(self) -> None:
        ...
        filters = [
            {"can_id": 0x283, "can_mask": 0xFFF, "extended": False},
            {"can_id": 0x284, "can_mask": 0xFFF, "extended": False},
        ]
    ...
    def leftMotorCallBack(self, msg) -> None:
        ...
        self.sendMessages(id=0x203, data=self.rpmLeftData)
    ...
    def rightMotorCallBack(self, msg) -> None:
        ...
        self.sendMessages(id=0x204, data=self.rpmRightData)

    def sendStartMessages(self) -> None:
        startMessages = []
        startMessages.append(
            can.Message(
                arbitration_id=0x603, data=[0x2B, 0x40, 0x60, 0x00, 0x80, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
                arbitration_id=0x603, data=[0x2B, 0x40, 0x60, 0x00, 0x06, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
                arbitration_id=0x603, data=[0x2B, 0x40, 0x60, 0x00, 0x0F, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
                arbitration_id=0x604, data=[0x2B, 0x40, 0x60, 0x00, 0x80, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
                arbitration_id=0x604, data=[0x2B, 0x40, 0x60, 0x00, 0x06, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
                arbitration_id=0x604, data=[0x2B, 0x40, 0x60, 0x00, 0x0F, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        startMessages.append(
            can.Message(
    ...
    def sendStopMessages(self) -> None:
        ...
        stopMessages.append(
            can.Message(
                arbitration_id=0x203, data=[0x00, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
        stopMessages.append(
            can.Message(
                arbitration_id=0x204, data=[0x00, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00], is_extended_id=False
            )
        )
